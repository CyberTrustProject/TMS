...
public class CvssV3_1 extends CvssV3 {
    ...
    private double roundUp1(double d) {
        ...
        if ((integerInput % 10000) == 0) {
        	...
        	// the cast in (double)integerInput is not needed, since integerInput is computed as d * 100000; cast inserted
        	// to silence a false positive SonarQube report
            return Math.floor((double)((double)integerInput / 10000) + 1) / 10.0;
        }
    }
